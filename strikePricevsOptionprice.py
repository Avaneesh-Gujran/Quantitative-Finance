...
call_prices = [blackScholes(r, S, K, T, sigma, 'call') for K in initial_price]
put_prices = [blackScholes(r, S, K, T, sigma, 'put') for K in initial_price]
...
plt.title('Option Price vs. Strike Stock Price')
plt.xlabel('Strike Stock Price')
plt.ylabel('Option Price')
plt.legend()
plt.grid(True)

plt.savefig('figureStrikePriceVsOptionPrice.png')
plt.show()
